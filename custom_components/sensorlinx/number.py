...
_NUMBER_ENTITIES: list[NumberDescriptor] = [
    ...
    NumberDescriptor(
        "heat_differential_control",
        "htDif",
        "hot_tank_differential",
        2,
        100,
        1,
        True,
    ...
    NumberDescriptor(
        "outdoor_reset_control",
        "dot",
        "hot_tank_outdoor_reset",
        -40,
        127,
        1,
        False,
    ...
    NumberDescriptor(
        "cold_differential_control",
        "clDif",
        "cold_tank_differential",
        2,
        100,
        1,
        True,
    ...
    NumberDescriptor(
        "cold_outdoor_reset_control",
        "cdot",
        "cold_tank_outdoor_reset",
        0,
        119,
        1,
        False,
